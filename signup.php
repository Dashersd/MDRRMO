...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Only proceed to create user if there are no validation errors
    if (empty($errors)) {
        // All accounts are now auto-approved by default
        $status = 'approved';
        ...
        if (createUser($user_data)) {
            $success_message = 'Account created successfully! You can now log in immediately.';
        } else {
            $errors[] = 'Failed to create account. This could be due to a technical error. Please try again.';
        }
    }
...
<html lang="en">
  <head>
    ...
    <title>MDRRMO Information System | Sign Up</title>
        ...
        <div class="signup-body">
          ...
          <form method="POST" action="" class="needs-validation" novalidate>
            ...
            <div class="mb-2">
              ...
              <input type="hidden" name="role" id="selectedRole" value="client" required>
